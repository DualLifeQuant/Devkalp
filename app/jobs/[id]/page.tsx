...
import { auditJob } from '@/lib/audit/auditLog'
...
export default function JobDetailPage() {
  ...
  const { data: job, isLoading: loading, isError } = useJob(id as string)
  ...
  const handleApply = async () => {
    ...
    try {
      ...
      auditJob('applied', id as string, user?.id, { job_title: job?.title })
      journey.jobApplied(id as string, job?.title ?? '')
    } catch (e: any) {
