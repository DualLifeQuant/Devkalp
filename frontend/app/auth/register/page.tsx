    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-5/12 bg-gradient-to-br from-trust-900 to-trust-800 relative overflow-hidden flex-col p-14">
        ...
        <div className="relative z-10">
          <Link href="/">
            <Image src="/devkalp-logo-removebg-preview.png" alt="Devkalp Foundation Logo" width={130} height={44} className="object-contain h-32 w-auto opacity-90" />
          </Link>
      ...
      <div className="flex-1 flex items-center justify-center p-4 md:p-8 overflow-y-auto bg-white max-h-screen">
        <div className="w-full max-w-md py-4">
          ...
          <p className="text-slate-500 text-sm mb-6">Join thousands of families who trust Devkalp.</p>

          {/* Step 1: Role Selection */}
          {step === 1 && (
            <div>
              <p className="text-sm font-medium text-slate-700 mb-3">I am joining as a…</p>
              <div className="grid grid-cols-2 gap-2.5 mb-6">
                {ROLES.map(r => (
                  <button key={r.value} type="button" onClick={() => setRole(r.value)}
                    className={clsx(
                      'p-3.5 rounded-2xl border-2 text-left transition-all duration-200 flex flex-col justify-center',
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-3.5">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="relative">
                  <Input label="Password" type={showPass ? 'text' : 'password'} placeholder="8+ chars" icon={<Lock size={16} />}
                ...
                <Input label="Confirm Password" type="password" placeholder="Repeat" icon={<Lock size={16} />}
