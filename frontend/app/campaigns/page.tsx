...
import { Leaf, Calendar, MapPin, Search, X, Check } from 'lucide-react'
          ...
          >
            ...
            >
              ...
              <div className="w-full md:w-1/2 p-4 md:p-6 space-y-4">
                <div className="h-64 sm:h-80 w-full rounded-2xl overflow-hidden shadow-sm relative group">
                  <img src={selectedCamp.cover_image || 'https://images.unsplash.com/photo-1593113598332-cd288d649433?w=800&q=80'} alt="Main" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
                </div>
                {selectedCamp.media_gallery && selectedCamp.media_gallery.length > 0 ? (
                  <div className="grid grid-cols-2 gap-4">
                    {selectedCamp.media_gallery.map((img: string, idx: number) => (
                      <div key={idx} className="h-32 rounded-xl overflow-hidden shadow-sm relative group bg-slate-100">
