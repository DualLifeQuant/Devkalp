...
const TESTIMONIALS = [
  { name: 'Sunita Devi', role: 'Health Educator', city: 'Nashik', quote: 'I\'ve facilitated 12 sessions in local schools. Seeing the girls gain confidence and knowledge — that\'s why I volunteer.' },
