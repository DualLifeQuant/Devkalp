...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-[#fafaf8]">
      ...
      <section ref={containerRef} className="relative min-h-[70vh] flex items-center justify-center bg-trust-950 overflow-hidden pt-28 pb-16">
        ...
        <div className="absolute top-1/4 right-10 w-96 h-96 bg-saffron-500/15 rounded-full blur-3xl pointer-events-none animate-pulse" />
        <div className="absolute bottom-10 left-1/4 w-96 h-96 bg-trust-400/15 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="page-container relative z-10 w-full max-w-5xl mx-auto text-center px-4 pt-8">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.45 }}
            ...
            {[
              { v: 2015, f: 1990, s: '', l: 'Year Founded' },
              { v: 850, f: 0, s: '+', l: 'Marriages Facilitated' },
              { v: 1200, f: 0, s: '+', sep: ',', l: 'School Sessions' },
            ].map((s, idx) => (
        ...
        <div className="page-container">
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={item.label} className="border border-slate-100 rounded-3xl p-8 hover:shadow-card transition-all duration-300">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-4 text-slate-600 leading-relaxed">
                ...
                <p>
                  We are headquartered in Surat, Gujarat, and our programs reach communities across Nashik, Nagpur, Mumbai, and surrounding rural areas.
                </p>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4">
              {[
                { value: 2015, from: 1990, suffix: '', label: 'Year Founded', sub: 'A decade of service' },
                { value: 850, from: 0, suffix: '+', label: 'Marriages Facilitated', sub: 'With care and counseling' },
                { value: 1200, from: 0, suffix: '+', separator: ',', label: 'School Sessions', sub: 'Health awareness delivered' },
                { value: 48, from: 0, suffix: '', label: 'Schools Reached', sub: 'Across Maharashtra' },
                { value: 320, from: 0, suffix: '+', label: 'Lives Placed', sub: 'In meaningful employment' },
              ].map(stat => (
