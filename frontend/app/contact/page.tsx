...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSending(true)
    // Simulate sending (in production: POST to a contact API endpoint)
          ...
          <div className="md:col-span-2 space-y-8">
            <div>
              ...
              <div className="space-y-4">
                {[
                  { icon: <Mail size={18} className="text-trust-600" />, label: 'Email', value: 'info@devkalpfoundation.org', href: 'mailto:info@devkalpfoundation.org' },
                  { icon: <Phone size={18} className="text-trust-600" />, label: 'Phone', value: '+91 98765 43210', href: 'tel:+919876543210' },
            ...
            <div className="space-y-2">
              ...
              {[
                { dept: 'Matrimony Counseling', email: 'matrimony@devkalpfoundation.org' },
                { dept: 'Donations & Partnerships', email: 'donations@devkalpfoundation.org' },
                { dept: 'HR / Careers', email: 'hr@devkalpfoundation.org' },
              ].map(d => (
