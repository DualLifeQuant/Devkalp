...
const FIELD_LABELS: Record<string, string> = {
  ...
  family_type: 'Family Type', marriage_status: 'Marital Status',
}
...
export default function CounselorProfilesPage() {
  ...
  useEffect(() => {
    counselorsApi.profiles({ limit: 50 })
  ...
  return (
    <div className="min-h-screen bg-[#f8f9fc] flex flex-col">
      <Navbar />
      <div className="flex-1 max-w-6xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-10 mt-16 md:mt-20">
        <div className="mb-6">
